...
//creating balloon     
balloon = createSprite(100,600,20,50);
...
function spawnObstaclesTop() 
{
  if(World.frameCount % 100 === 0) {
    obstacleTop = createSprite(1200,100,40,50);
...
{
  if(World.frameCount % 100 === 0) {
    obstacleBottom = createSprite(1200,650,40,50);
